...
/**
 * Classe che associa ad ogni gpio logico il corrispettivo pin.
 */
public class Config {
  /**
   * Array di pin.
   */
  public static final Pin[] pinMap = { RaspiPin.GPIO_00, RaspiPin.GPIO_01, RaspiPin.GPIO_02,
      ...
      RaspiPin.GPIO_18, RaspiPin.GPIO_20 };
}
